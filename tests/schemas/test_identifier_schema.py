...
def validate_other(identifier):
    """Always True validation function."""
...
# |    -   |   [DOI]  |       [Other]       | 10.12345/foo.bar |  fail  |
# |    -   |   [DOI]  |         []          | 10.12345/foo.bar |  fail  |
# |    -   | [ISSN,   |       [ISSN]        |     0317-8471    |  pass  |  (scheme = issn)  # noqa
# |        |  PubMed] |                     |                  |        |
# |    -   | [ISSN,   |      [PubMed]       |     0317-8471    |  pass  |  (scheme = pubmed)  # noqa
# |        |  PubMed] |                     |                  |        |
...
def test_detected_and_allowed_scheme_respect_detection_orther():  # 8
    # NOTE: pmid is PubMed ID
